...
const resolveParserInput = (
  uastringOrExtensions?: ParserInput,
  extensions?: ParserExtensions,
): { uastring: string | undefined, extensions: ParserExtensions | undefined } => {
...
const getRuntimeNavigator = (): UANavigator | undefined => {
...
const parseBrowserFromContext = (context: ParserContext): IBrowser => {
...
const parseCPUFromContext = (context: ParserContext): ICPU => {
  const cpu: ICPU = {
...
const parseDeviceFromContext = (context: ParserContext): IDevice => {
...
const parseEngineFromContext = (context: ParserContext): IEngine => {
...
const parseOSFromContext = (context: ParserContext): IOS => {
  const os: IOS = {
    name: undefined,
    version: undefined,
  }
...
export const parseBrowser = (
  uastringOrExtensions?: ParserInput,
  extensions?: ParserExtensions,
): IBrowser => parseBrowserFromContext(createParserContext(uastringOrExtensions, extensions))

export const parseCPU = (
  uastringOrExtensions?: ParserInput,
  extensions?: ParserExtensions,
): ICPU => parseCPUFromContext(createParserContext(uastringOrExtensions, extensions))

export const parseDevice = (
  uastringOrExtensions?: ParserInput,
  extensions?: ParserExtensions,
): IDevice => parseDeviceFromContext(createParserContext(uastringOrExtensions, extensions))

export const parseEngine = (
  uastringOrExtensions?: ParserInput,
  extensions?: ParserExtensions,
): IEngine => parseEngineFromContext(createParserContext(uastringOrExtensions, extensions))

export const parseOS = (
  uastringOrExtensions?: ParserInput,
  extensions?: ParserExtensions,
): IOS => parseOSFromContext(createParserContext(uastringOrExtensions, extensions))
